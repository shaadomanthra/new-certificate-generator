<form action="edit_default_template" method="POST">
    ...
    <div class="row">
        <div class="col-6 mt-2">
            <label class="font-weight-bold">Main Logo</label>
            <select class="custom-select bg-dark text-white" name="main_logo">
                ...
                @php
                        ...
                        $l = $l[0];
                    @endphp
                    <option value="{{$logo}}" {{$file->main_logo == $logo ? "selected" : ""}}>{{$l}}</option>
                    @endforeach
            </select>
        </div>
        <div class="col-6 mt-2">
            <label class="font-weight-bold">Logo 1</label>
        ...
        <div class="col-6 mt-2">
            <label class="font-weight-bold">Logo 2</label>
        ...
        <div class="col-6 mt-2">
            <label class="font-weight-bold">Logo 3</label>
            <select class="custom-select bg-dark text-white" name="logo_3">
                <option value="default">Default</option>
                @foreach($logos as $logo)
                @php
                    $l = explode("/", $logo);
                    ...
                    $l = $l[0];
                    @endphp
                <option value="{{$logo}}" {{$file->logo_3 == $logo ? "selected" : ""}}>{{$l}}</option>
                @endforeach
            </select>
        </div>
        <h6 class="my-2 ml-3"><span class="text-danger">Note: </span> Leave empty for default logos</h6>
    </div>
    ...
    <div class="bg-dark text-white p-3 rounded-lg">
        ...
        <input type="text" class="form-control mt-2" name="line_7" value="{{$file->line_7}}">
    </div>
        ...
        <div class="row d-flex">
            <div class="col-6 form-group">
                <div class="bg-dark rounded-lg p-3 ">
                    <label class="font-weight-bold">Sign 1</label>
            ...
            <div class="col-6 form-group ">
                <div class="bg-dark rounded-lg p-3">
                    <label class="font-weight-bold">Sign 2</label>
            ...
            <div class="col-6 form-group">
                <div class="bg-dark rounded-lg p-3">
                    <label class="font-weight-bold">Sign 3</label>
                    <select class="custom-select" name="sign_3">
                        <option value="default">Default</option>
                        @foreach($signs as $sign)
                            @php
                                $name = explode("/", $sign);
                                ...
                                $name = $name[0];
                            @endphp
                            <option value="{{$sign}}" {{$file->sign_3 == $sign ? "selected" : ""}}>{{$name}}</option>
                        @endforeach
                    </select>

                    <label class="font-weight-bold mt-3">Name</label>
                    <input type="text" class="form-control" name="sign_name_3" value="{{$file->sign_name_3}}">

                    <label class="font-weight-bold mt-3">Info</label>
                    <input type="text" class="form-control" name="sign_info_3" value="{{$file->sign_info_3}}">
                </div>
            </div>
            <div class="col-6 form-group">
                <div class="bg-dark rounded-lg p-3">
                    <label class="font-weight-bold">Sign 4</label>
                    <select class="custom-select" name="sign_4">
                        <option value="default">Default</option>
                        @foreach($signs as $sign)
                            @php
                                $name = explode("/", $sign);
                                ...
                                $name = $name[0];
                            @endphp
                            <option value="{{$sign}}" {{$file->sign_4 == $sign ? "selected" : ""}}>{{$name}}</option>
                        @endforeach
                    </select>

                    <label class="font-weight-bold mt-3">Name</label>
                    <input type="text" class="form-control" name="sign_name_4" value="{{$file->sign_name_4}}">

                    <label class="font-weight-bold mt-3">Info</label>
                    <input type="text" class="form-control" name="sign_info_4" value="{{$file->sign_info_4}}">
                </div>
            </div>
        </div>
    </div>
